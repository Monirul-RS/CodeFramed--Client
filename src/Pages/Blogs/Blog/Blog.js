        ...
        <div className='mt-5'>
            ...
            <Accordion className='container' defaultActiveKey={['0']} alwaysOpen>
                <Accordion.Item eventKey="0">
                    <Accordion.Header><p className='fs-3 fw-semibold text-primary'>1. What is cors?</p></Accordion.Header>
                ...
                <Accordion.Item eventKey="1">
                    <Accordion.Header><p className='fs-3 fw-semibold text-primary' >2.Why are you using firebase? What oher options do you have to implement authentication?</p></Accordion.Header>
                    <Accordion.Body className='fs-4 text-start'>
                ...
                <Accordion.Item eventKey="2">
                    <Accordion.Header><p className='fs-3 fw-semibold text-primary'>3. How does private route work?</p></Accordion.Header>
                    <Accordion.Body className='fs-4 text-start'>
